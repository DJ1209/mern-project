...
router.get('/', function(req, res, next) {
  ContactModel.find(function(err, db_users_array) {
    if (err) {
        ...
        res.render('admin/contact/display', { user_array : db_users_array });
      }
  });
});
...
router.get('/delete/:id', function(req, res) {
  ContactModel.findByIdAndDelete(req.params.id, function(err, project) {
    if (err) {
