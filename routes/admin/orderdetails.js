...
router.get('/', function(req, res, next) {
    OrderDetailsModel.find(function(err, db_users_array) {
    if (err) {
        ...
        res.render('admin/orderdetails/display', { user_array : db_users_array });
      }
  });
});
...
router.get('/delete/:id', function(req, res) {
  OrderDetailsModel.findByIdAndDelete(req.params.id, function(err, project) {
    if (err) {
