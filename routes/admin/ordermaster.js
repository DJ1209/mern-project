...
router.get('/', function(req, res, next) {
  OrderMasterModel.find(function(err, db_users_array) {
    if (err) {
        ...
        res.render('admin/ordermaster/display', { user_array : db_users_array });
      }
  });
});
...
router.get('/delete/:id', function(req, res) {
  OrderMasterModel.findByIdAndDelete(req.params.id, function(err, project) {
    if (err) {
      ...
      console.log(" Record Deleted ");
        res.redirect('/admin/ordermaster/');
    }
});
});
